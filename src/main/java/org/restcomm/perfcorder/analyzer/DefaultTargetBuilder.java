...
public class DefaultTargetBuilder {
    public static AnalysisFileTargetSet build(){
        ...
        AnalysisFileTarget topFileTarget = new AnalysisFileTarget("data/periodic/java/jvmtop.txt", ',', 1);
        ...
        AnalysisFileTarget analysisFileTarget = new AnalysisFileTarget("data/periodic/sip/sipp.csv", ';', 1);
        ...
        AnalysisFileTarget jgcTarget = new AnalysisFileTarget("data/periodic/java/jgcstat.txt", ',', 1);
        ...
        AnalysisFileTarget jmeterTarget = new AnalysisFileTarget("data/periodic/http/jmeter.csv", ' ', 1);
        ...
        AnalysisFileTarget histTarget = new AnalysisFileTarget("data/periodic/java/objs.hist", ' ', 1);
